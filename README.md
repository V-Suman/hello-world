...
What is happening in my code is.. when I enter all the three contacts like primary phone, secondary phone and email address 
the contactsDto this is how the contactsDto looks. LIke this: case-1 [
    {
        "contactTypeId": 1,
...
If I only entered email (cause its mandatory), and primary phone (cause it is mandatory) and not secondary phone 
(cause it is not mandatory) it is getting populated like this: case -2 [
    {
        "contactTypeId": 1,
        "contactType": "Phone",
        "contactId": 358473,
        "applicantId": 1000008,
        "contactValue": "2123123123",
        "isPrimary": true
    },
    {
        "contactTypeId": 2,
...
Now.. on the front end.. the secondary phone field is displaying the email address in case - 2 which is not supposed to happen. 
in case -1 the data is displayed correctly! 
